...
/// <summary>
/// The logging interface is used for as a bridge to log specific things. Pioneer.Net has no logger implemented and
...
{
    /// <summary>
    /// Gets called when Pioneer.Net has thrown an exception.
    /// </summary>
